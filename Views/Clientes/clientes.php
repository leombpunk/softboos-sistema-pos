...
<main class="app-content">
    <div class="app-title">
        <div>
            ...
            <button class="btn btn-primary" type="button" onclick="openModal();" data-toggle="modal" data-target="#clientesModalCenter" <?= ($_SESSION["permisos"][0]["AGREGAR"] == 1)?'title="Registrar"':'disabled title="No tienes permiso"' ?>>
