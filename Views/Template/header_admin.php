...
<head>
    ...
    <link rel="shortcut icon" href="<?= media();?>images/uploads/favicon.ico" type="image/x-icon">
    <!-- Main CSS-->
...
<body class="app sidebar-mini">
    ...
    <header class="app-header"><a class="app-header__logo" href="<?= base_url();?>dashboard">SoftBoos</a>
        ...
        <ul class="app-nav">
            ...
            <!--Notification Menu-->
            <li class="dropdown"><a class="app-nav__item" href="<?= base_url();?>notificaciones" data-toggle="tooltip" aria-label="Ir a notificaciones"><i id="bell_head" class="fa fa-bell-o fa-lg"></i></a>
            ...
            <!-- User Menu-->
            <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Ir al perfil"><i class="fa fa-user fa-lg"></i></a>
