...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-03-2023 a las 16:56:05
...
(88, 1, 0000000000001, 1, 1000000056, 1, 1, 3, '2023-03-21 19:09:19', '2023-03-21 19:09:19', '', '1100.00', '57.14'),
(89, 1, 0000000000001, 1, 1000000056, 1, 1, 3, '2023-03-21 19:10:32', '2023-03-21 19:10:32', '', '300.00', '28.57'),
(90, 1, 0000000000003, 1, 1000000056, 1, 1, 3, '2023-03-21 19:13:42', '2023-03-21 19:13:42', '', '500.00', '28.57');
...
(15, 45, 'COMBO FALOPA', 'ASDASDDS', '2023-03-28 16:25:57', NULL, NULL, 1, 1);
...
--
ALTER TABLE `facturaventa_formapago`
  MODIFY `FACTURAVFP_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
...
--
ALTER TABLE `lista_insumos`
  MODIFY `INSUMO_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `mercaderias`
  MODIFY `MERCADERIA_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT de la tabla `mercaderias_cantidad_actual`
--
ALTER TABLE `mercaderias_cantidad_actual`
  MODIFY `STOCKACTUAL_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `mercaderias_precios`
--
ALTER TABLE `mercaderias_precios`
  MODIFY `MP_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `mercaderias_unidadesmedida`
--
ALTER TABLE `mercaderias_unidadesmedida`
  MODIFY `MERCAUNIMED_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT de la tabla `modulos`
--
ALTER TABLE `modulos`
  MODIFY `MODULO_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `permisos`
  MODIFY `PERMISO_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
...
--
ALTER TABLE `recetas`
  MODIFY `RECETA_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT de la tabla `rubros`
--
ALTER TABLE `rubros`
  MODIFY `RUBRO_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
